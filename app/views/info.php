...
<body>
    <div class="navbar">
      ...
      <a class="active" href="info">Informacje</a>
    ...
    <section class="intro">
        <h2>
            1. Poziomy zaawansowania w danym języku
        </h2>
        <table>
            <tr>
                <th>Poziom</th>
            ...
            <tr>
                ...
                <td>
                    <ul>
                        <li>Rozumie i bardzo często używa podstawowych zwrotów, jak również podstawowych sformułowań dotyczących życia codziennego</li>
                        <li>Potrafi przedstawić siebie i innych oraz potrafi formułować pytania odnoszące się do życia prywatnego oraz dotyczące miejsca zamieszkania, posiadanych rzeczy i innych osób</li>
                        <li>Potrafi przeprowadzić prostą rozmowę pod warunkiem, że rozmówca mówi wolno, wyraźnie i chce współpracować.</li>
                    </ul>
                </td>
            </tr>
            <tr>
        ...
        <p>
            <a href="https://www.britishcouncil.pl/angielski/poziomy-dorosli" target="_blank">
                Poziomy języka wg britishcouncil
            </a>
        </p>
    </section>
    <footer class="ftr">
